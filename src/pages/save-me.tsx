...
const testSerializedTX =
  "";

const USDC = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";
// const signer = "Fakzon26tKzdGKW5g2wvZM12y6TLvqPGgogE29Nq8ACB";
const signer = "Fakzon26tKzdGKW5g2wvZM12y6TLvqPGgogE29Nq8ACB";
const targetWallet = "FEyGiSaqFMPz8VbKpPE4oRTotxaDMdPVDaxH9fXyu4Zf";
  ...
  const onSubmit = async () => {
    ...
    if (
      ...
      const txToSign = await createVersionedTransaction(
        ...
        undefined,
        undefined,
        "2qajTC3xAM2nqAUgG9SxdrYYtSdbZXXXdHbB62EwKusw",
      );
